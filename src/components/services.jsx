...
const services = [
    { 
        ...
        description: "Fast, responsive, and accessible web solutions tailored to your needs" 
    },
    { 
        title: "WordPress Sites", 
        description: "Custom WordPress development with powerful features and easy management" 
    },
    { 
...
return (    
    <div className="h-screen overflow-y-hidden py-8 md:py-12 px-2">
        <div className="mx-auto flex flex-col items-center">
            ...
            >
                <p className="text-base md:text-lg text-center max-w-2xl mx-auto mb-8 md:mb-12">
                    We offer end-to-end design and development services to bring your product vision to life.
                </p>
